...
1. **Web Scraping**:
   - Se ha utilizado biblioteca  **Beautiful Soup**  para extraer datos de múltiples sitios web.
...
3. **Procesamiento de datos con Python/Pandas**:
   - Se ha utilizado la biblioteca **Pandas** para realizar la limpieza, transformación y análisis de los datos obtenidos.
   - Se han llevado a cabo operaciones como filtrado, agregación y cálculos estadísticos para obtener información relevante.

4. **Generación de informes en Excel**:
...
5. **Orquestación y automatización con GitHub Actions**:
...
6. **Comunicación efectiva de resultados por correo electrónico Google**:
